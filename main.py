from autokoltsonzo import Autokolcsonzo
from szemelyauto import Szemelyauto
from teherauto import Teherauto
import datetime

autoKoltsonzo1 = Autokolcsonzo("Pozsgás és társa költsönző DABAS")
...
autoKoltsonzo1.auto_hozzaad(auto1)
autoKoltsonzo1.auto_hozzaad(auto2)
autoKoltsonzo1.auto_hozzaad(auto3)


autoKoltsonzo1.berel_auto(auto1, datetime.date(2025, 12,11))
autoKoltsonzo1.berel_auto(auto2, datetime.date(2025, 11, 14))
autoKoltsonzo1.berel_auto(auto3, datetime.date(2025, 9, 10))
autoKoltsonzo1.berel_auto(auto3, datetime.date(2026, 1, 9))
...
while True:
    ...
    if parancs == "/lista" :
        print(autoKoltsonzo1.get_auto())

    elif parancs =="/listab":
        print(autoKoltsonzo1.get_berlesek())

    elif parancs == "/berles":
        i = int(input("Az elérhető bérelhető járművekből adja meg a sorszámát amit ki szeretne választani: "))
        kivalasztottAuto= autoKoltsonzo1.get_auto_as_object()[i-1]
        ...
        #print(type(datum))
        autoKoltsonzo1.berel_auto(kivalasztottAuto, datum)
        ...
        datum = datetime.datetime.strptime(datum_str, "%Y-%m-%d").date()
        #print(type(datum))
        autoKoltsonzo1.lemond_berlest(kivalasztottAuto, datum)
